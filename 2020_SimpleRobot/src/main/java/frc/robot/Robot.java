...
public class Robot extends TimedRobot {
	...
	public void disabledPeriodic() {
		System.out.println(driverController.getAxis(GameController.LEFT_STICK, GameController.Y_AXIS));
		System.out.println(driverController.getAxis(GameController.RIGHT_STICK, GameController.Y_AXIS));
